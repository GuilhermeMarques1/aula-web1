...
public class Camera {
  ...
  @JoinTable(name = "cameras_usuarios", uniqueConstraints = @UniqueConstraint(columnNames = { "camera_id",
      "usuario_id" }, name = "unique_user_camera"), joinColumns = @JoinColumn(name = "camera_id", referencedColumnName = "id", table = "camera", unique = false), inverseJoinColumns = @JoinColumn(name = "usuario_id", referencedColumnName = "id", table = "usuario", unique = false
  // updatable = false,
  ))
