...
public class Usuario implements UserDetails {
  ...
  @JoinTable(name = "cameras_usuarios", uniqueConstraints = @UniqueConstraint(columnNames = { "camera_id",
      "usuario_id" }, name = "unique_user_camera"), joinColumns = @JoinColumn(name = "usuario_id", referencedColumnName = "id", table = "usuario", unique = false), inverseJoinColumns = @JoinColumn(name = "camera_id", referencedColumnName = "id", table = "camera", unique = false))
